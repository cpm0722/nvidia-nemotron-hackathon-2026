"""Shared Pydantic schemas used by all scrapers and NAT function wrappers."""
...
class EvidenceItem(BaseModel):
    ...
    source: str = Field(..., description="Short source tag: github|reddit|hackernews|rss|huggingface")
    source_detail: str = Field(..., description="e.g. 'r/LocalLLaMA' or 'issues:huggingface/transformers'")
    url: str
    ...
    body_full: str | None = Field(
        None,
        description="Full extracted body, populated by `enrich_bodies` step (trafilatura).",
    )
