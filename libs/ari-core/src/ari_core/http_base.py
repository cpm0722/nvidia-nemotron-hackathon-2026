"""Shared helpers for scraper modules: User-Agent, timeout, Timer, datetime helpers."""
...
class Timer:
    """Context manager exposing `elapsed_ms`. Readable both inside and after the `with` block."""
