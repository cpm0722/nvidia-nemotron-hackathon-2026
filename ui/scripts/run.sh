...
export NAT_UI_ORCHESTRATOR_URL="${NAT_UI_ORCHESTRATOR_URL:-http://localhost:10000}"
export ARI_RUNS_ROOT="${ARI_RUNS_ROOT:-$(cd "$UI_DIR/.." && pwd)/runs}"

echo "=== nat_ui server ==="
echo "host:       $NAT_UI_HOST"
echo "port:       $NAT_UI_PORT"
echo "stub_mode:  $NAT_UI_STUB  (1 = stub, 0 = real orchestrator agent)"
echo "orchestrator_url: $NAT_UI_ORCHESTRATOR_URL"
